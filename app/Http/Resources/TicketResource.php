    ...
    public function toArray($request)
    {
        return [
            ...
            'movie' => [
                ...
                'genres' => $this->movie->genres ? ListResource::collection($this->movie->genres) : '',
                'directors' => $this->movie->directors ? ListResource::collection($this->movie->directors) : '',
                'casts' => $this->movie->casts ? ListResource::collection($this->movie->casts) : '',
